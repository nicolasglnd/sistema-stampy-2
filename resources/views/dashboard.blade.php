                ...
                <div class="hero-content text-center">
                    <div class="max-w-md">
                        ...
                        <p class="py-6">Provident cupiditate voluptatem et in. Quaerat fugiat ut
                            assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a idnisi.
                        </p>
                        <a href="{{ route('inventarios.index') }}" class="btn btn-primary">Consultar inventarios</a>
                    </div>
                </div>
            </div>
        </div>
